...
namespace VendasWebAplication.Data
{
    ...
    {
        //Aqui vou declarar meu context
        private VendasWebAplicationContext _context;

        //Aqui vou criar um construtor para dizer que a injeção de dependências deve acontecer
        public SeedingService(VendasWebAplicationContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            //Vou usar o "Any()" para testar se já existe um serviço na minha base de dados
            if(_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                //Se já existir uso o return para não fazer mais nada
                return;
            }
            ...
            //AddRange permite que você adicione diversos objetos de uma só vez
            ...
            //SaveChanges, metodo para salvar e confirmar as alterações no banco de dados
